...
select * from (
  values
    ...
    ('Products', '/products', 'header', 4, true),
    ('Digital Check-Up', '/checkup', 'header', 5, true),
    ('Contact', '/contact', 'header', 6, true),
    ('About', '/about', 'footer', 0, true),
    ('Services', '/services', 'footer', 1, true),
    ('Work', '/work', 'footer', 2, true),
    ('Products', '/products', 'footer', 3, true),
    ('Digital Check-Up', '/checkup', 'footer', 4, true),
    ('Contact', '/contact', 'footer', 5, true),
    ('Instagram', 'https://instagram.com/thisisyoca', 'footer', 6, true),
    ('Email', 'mailto:connect@yoca.net', 'footer', 7, true)
